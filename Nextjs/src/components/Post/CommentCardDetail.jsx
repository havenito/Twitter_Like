...
const CommentCardDetail = ({ comment }) => {
  ...
  const getDisplayName = () => {
    if (!comment.user) return 'Utilisateur introuvable';
    
    const firstName = comment.user.first_name || comment.user.firstName;
    const lastName = comment.user.last_name || comment.user.lastName;
    const pseudo = comment.user.pseudo;
