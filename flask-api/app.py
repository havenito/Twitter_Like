...
def create_user():
    ...
    try:
        ...
        new_user = User(email=email, password=password, role=role, first_name=first_name, last_name=last_name, profile_picture=profile_picture, is_accepted=is_accepted, private=private, pseudo=pseudo)
        # Vérifier si l'utilisateur existe déjà
        existing_user = User.query.filter_by(email=email).first()
        existing_pseudo = User.query.filter_by(pseudo=pseudo).first()
        if existing_user or existing_pseudo:
