// filepath: c:\Users\alexd\Bureau\Deuxième année - B2\Projet de Groupe\Code\Twitter_Like\src\app\components\HomePage\ParallaxIntro.jsx
"use client";
...
const ParallaxIntro = () => {
  ...
  return (
    <div className="relative h-[150vh] overflow-hidden flex items-center justify-center bg-gradient-to-br from-[#1e1e1e] to-[#121212]">
      ...
      >
        <h1 className="text-6xl md:text-8xl font-bold text-gray-600 opacity-50">
          Minouverse
        </h1>
      </motion.div>
      ...
      >
        <h2 className="text-4xl md:text-6xl font-semibold text-gray-400 opacity-70">
          Le réseau félin
        </h2>
      </motion.div>
      ...
      >
        <h1 className="text-7xl md:text-9xl font-extrabold text-[#90EE90]">
          Minouverse
        </h1>
      </motion.div>
